...
/* Basic Settings */
$conf['title']       = 'MuRoX';           //what to show in the title
...
$conf['auth_security_timeout'] = 0;    //time (seconds) auth data is considered valid, set to 0 to recheck on every page view
$conf['securecookie'] = 1;               //never send HTTPS cookies via HTTP
$conf['remote']      = 0;                //Enable/disable remote interfaces
$conf['remoteuser']  = '!!not set !!';   //user/groups that have access to remote interface (comma separated)

/* Antispam Features */
$conf['usewordblock']= 0;                //block spam based on words? 0|1
...
$conf['mailguard']   = 'none';            //obfuscate email addresses against spam harvesters?
                                         //valid entries are:
