#ifndef CLAAS_CONSTANTS_H_
#define CLAAS_CONSTANTS_H_

/*! \brief Constants regarding the CLAAS project
 *
 *  This header contains constant variables
 *  regarding the CLAAS project, which means that
...
namespace scopes {
  ...
  const std::string odometry("/plan/Fahrzeugdaten");
  const std::string canClaas("/sense/ClaasCan/rx");
  const std::string canJ1939("/sense/J1939Can/rx");
  const std::string canFront("/sense/FrontAtt/rx");
  const std::string canSteer("/sense/Steering/rx");
  const std::string canMess("/sense/MessCan/rx");
  const std::string canClaas_out("/act/ClaasCan/tx");
  const std::string canJ1939_out("/act/J1939Can/tx");
  const std::string canFront_out("/act/FrontAtt/tx");
  const std::string canSteer_out("/act/Steering/tx");
  const std::string canMess_out("/act/MessCan/tx");
  const std::string lase1("/sense/LASE2000D/1");
  const std::string lase2("/sense/LASE2000D/2");
  const std::string hokuyo("/sense/Hokuyo");
  const std::string sick1("/sense/SickLDMRS/1");
  const std::string sick2("/sense/SickLDMRS/2");
  const std::string sick3("/sense/SickLDMRS/3");
  const std::string pf("/sense/PepperlFuchsOMD8000");
  const std::string leuz("/sense/LeuzODSL/1");
