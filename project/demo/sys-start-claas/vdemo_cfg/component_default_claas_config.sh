...
export VDEMO_component_KappaZelos_BW_1="KappaZelos_BW_1,$cam, -c  -g sense -L 1 -w 2:"
export VDEMO_component_KappaZelos_RGB_1="KappaZelos_RGB_1,$cam, -c  -g sense -L 1 -w 2:"
...
$VDEMO_component_KappaZelos_BW_1\
$VDEMO_component_KappaZelos_RGB_1\
