...
./CoreSLAMLocalization/CoreSLAMLocalization --odominscope /AMiRo_Hokuyo/odom/ --lidarinscope /AMiRo_Hokuyo/lidar/ --senImage 1 --delta 0.01 --sigma_theta 0.18 --hole_width 0.2 "$@" &
