...
//=============================================================================
	...
	enum CarriageWayType
	{
		...
		CWT_TRUNK,        /*!< Used for highway similar roads (Germany: Autobahnaehnliche Strasse,
                           umgangssprachlich: Schnellstraße) */
...
//=============================================================================
	...
	//===========================================================================
	/*! \brief Constructor for std::map initialization, since const private maps
	 * need to be initialized by Constructor or function within C++98 standard
	 *///------------------------------------------------------------------------
