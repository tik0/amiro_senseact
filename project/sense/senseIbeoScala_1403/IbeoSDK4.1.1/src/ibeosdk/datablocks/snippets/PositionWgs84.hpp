...
public:
	 ...
	 * \param[out] pdX The distance in x-direction
	 * \param[out] pdY The distance in y-direction
	 *
	 * \sa transformToTangentialPlane()
	 */
	void transformToTangentialPlaneWithHeading(const PositionWgs84& origin, double* pdX, double* pdY) const;
	 ...
	 *
	 * \param[in] dX      The distance in x-direction
	 * \param[in] dY      The distance in y-direction
	 * \param[in] origin  The reference coordinate system
	 *
	 * \sa transformFromTangentialPlane()
	 */
	void transformFromTangentialPlaneWithHeading(const double dX, const double dY, const PositionWgs84& origin);
