...
bool Lane::serialize(std::ostream& os) const
{
	...
	ibeosdk::writeBE(os, hasNext() ? getNext()->getId() : u0);                     // 1;
	ibeosdk::writeBE(os, hasPrevious() ? getPrevious()->getId() : u0);             // 1;
	ibeosdk::writeBE(os, hasLeft() ? getLeft()->getId() : u0);                     // 1;
	ibeosdk::writeBE(os, hasRight() ? getRight()->getId() : u0);                   // 1;
