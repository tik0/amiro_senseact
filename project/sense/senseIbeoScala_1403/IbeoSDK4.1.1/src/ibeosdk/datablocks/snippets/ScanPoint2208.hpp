...
public:
	enum ScanPoint2208Flags {
		...
		SPFML_Reflector       = 0x0020,
		SPFML_NearRange       = 0x0040,
		SPFML_Noise           = 0x0080,

		SPFML_LeftCovered     = 0x0100,
		SPFML_RightCoverd     = 0x0200,
		SPFML_Background      = 0x0400,
		SPFML_Marker          = 0x0800,

		SPFML_Transparent     = 0x1000,
		SPFML_ExtTransparency = 0x2000,
		SPFML_InterlacingPt   = 0x4000, // only for A1 prototype
		SPFML_Reserved1       = 0x8000
	};
