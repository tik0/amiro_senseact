...
void live_demo(LogFileManager& logFileManager, std::string ip)
{
	...
	scala.registerListener(dynamic_cast<DataListener<FrameEndSeparator>*>(&allScalaListener));
	scala.registerListener(dynamic_cast<DataListener<ScanLux>*>(&allScalaListener));
	scala.registerListener(dynamic_cast<DataListener<Scan2208>*>(&allScalaListener));
