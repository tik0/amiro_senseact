...
int RS232_OpenComport(int comport_number, int baudrate, const char *mode, const int block_for_n_bytes)
{
  int baudr,
      status;
...
*/
  ...
  new_port_settings.c_cc[VMIN] = block_for_n_bytes;      /* block untill n bytes are received */
