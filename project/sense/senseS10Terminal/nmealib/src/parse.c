...
void nmea_GPRMC2info(nmeaGPRMC *pack, nmeaINFO *info)
{
    ...
    info->status = pack->status;
    info->declination = pack->declination;
    info->declin_ew = pack->declin_ew;
    info->mode = pack->mode;
}
...
void nmea_GPVTG2info(nmeaGPVTG *pack, nmeaINFO *info)
{
    ...
    info->dir_t = pack->dir_t;
    info->dec_m = pack->dec_m;
    info->spn = pack->spn;
