...
function getLightMessage(){
	...
	if(whiteLight == 0){
		...
		} else{document.getElementById("whiteLight").value="Weißes Licht an";}
	if(redLight == 0){
		red="aus /";
		document.getElementById("redLight").value="Rotes Licht aus";
		} else{document.getElementById("redLight").value="Rotes Licht an";}
	if(greenLight == 0){
		green="aus /";
		document.getElementById("greenLight").value="Gruenes Licht aus";
		} else{document.getElementById("greenLight").value="Gruenes Licht an";}
	if(blueLight == 0){
		blue="aus";
		document.getElementById("blueLight").value="Blaues Licht aus";
		} else{document.getElementById("blueLight").value="Blaues Licht an";}
...
/*
 * Setting all Light buttons back to default
 *
 */
...
function setControlImgBack(){
	...
	if(in_control){socket_Camera_Infrared.send(1099);} // send stop Signal
}
