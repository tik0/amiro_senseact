...
extern "C" {
  ...
  extern P_Odemetrie_T Odemetrie_P;
...
extern DW_Odemetrie_T Odemetrie_DW;
...
extern "C" {
  ...
  /* External inputs (root inport signals with auto storage) */
  extern ExtU_Odemetrie_T Odemetrie_U;

  /* External outputs (root outports fed by signals with auto storage) */
  extern ExtY_Odemetrie_T Odemetrie_Y;
...
extern "C" {
  ...
  extern void Odemetrie_initialize(void);
  extern void Odemetrie_step(void);
  extern void Odemetrie_terminate(void);
...
extern "C" {
  ...
  extern RT_MODEL_Odemetrie_T *const Odemetrie_M;
